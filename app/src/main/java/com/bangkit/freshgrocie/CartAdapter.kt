...
internal class CartAdapter (
    private val courseList: List<CartModel>,
    ...
    private lateinit var courseTVP: TextView
    private lateinit var courseTVQTY: TextView
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        courseIV = convertView!!.findViewById(R.id.cart_product)
        courseTV = convertView!!.findViewById(R.id.cart_product_name)
        courseTVP = convertView!!.findViewById(R.id.cart_product_price)
        courseTVQTY = convertView!!.findViewById(R.id.cart_product_price)
